...
int main(){
    ...
    printf("\n===== CARTA 1 ===== \nEstado: %c\nCódigo: %s\nNome da Cidade: %s\nPopulação: %d\nÁrea: %f km²\nPIB: %f\nNúmero de Pontos Turísticos: %d\n", Estado_1, Codigo_1, NomeDaCidade_1, Populacao_1, Area_1, PIB_1, PontosTuristicos_1);
    printf("\n===== CARTA 2 ===== \nEstado: %c\nCódigo: %s\nNome da Cidade: %s\nPopulação: %d\nÁrea: %f km²\nPIB: %f\nNúmero de Pontos Turísticos: %d\n", Estado_2, Codigo_2, NomeDaCidade_2, Populacao_2, Area_2, PIB_2, PontosTuristicos_2);
